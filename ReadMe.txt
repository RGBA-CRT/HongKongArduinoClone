...
◇概要
	...
	高速化・セーブデータの読書き・特殊カートリッジへの対応を行ったものです。
...
◇注意
	...
	特にセーブデータは消えやすいので注意してください。
	吸い出したROMイメージをインターネット上に公開することは犯罪です。
...
◇Q&A
	・[x0][x1][x2][x3][x4]…と表示され、吸出しできない
		通信速度が高すぎる可能性があります。Arduinoに乗っているシリアルコンバータによって通信可能な最高速度が変わります。
		参考：
			CH340      : 1000000 bps ・・・　互換品によく使用されているもの
			ATMega16u2 :  500000 bps ・・・　純正品に近いもの
			FT232RL    : 不明
